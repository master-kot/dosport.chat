...
import ru.dosport.chat.repositories.ChatMessageRepository;
import ru.dosport.chat.repositories.ChatRoomRepository;
import ru.dosport.chat.services.api.ChatMessageService;
...
public class ChatMessageServiceImpl implements ChatMessageService {
    ...
    public List<ChatMessage> findChatMessages(String senderId, String recipientId) {
        ...
        List<ChatMessage> messages = chatId.map(chatMessageRepository::findByChatId).orElse(new ArrayList<ChatMessage>());
